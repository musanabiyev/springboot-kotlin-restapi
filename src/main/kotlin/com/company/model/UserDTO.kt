...
data class UserDTO(
    ...
    @ApiModelProperty(notes = "personal email of user", value = "test@test.com", required = true)
    @field:Email(regexp = "^(.+)@(.+)\$", message = "Email is not valid. Please follow the example: test@test.com.com")
    @field:NotBlank
    var email: String?,
